                    ...
                    <div class="single-post-details-area">
                        <div class="post-content">
                            ...
                            <div class="post-thumbnail mb-30">
                                <img src="http://localhost/alazea/public/assets/img/bg-img/35.jpg" alt="">
                            </div>
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-5">
                                    <img src="http://localhost/alazea/public/assets/img/bg-img/36.jpg" alt="">
                                </div>
                            </div>
                        ...
                        <ol>
                            ...
                            <li class="single_comment_area">
                                <div class="comment-wrapper d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="http://localhost/alazea/public/assets/img/bg-img/37.jpg" alt="">
                                    </div>
                                    <!-- Comment Content -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        <div class="comment-wrapper d-flex">
                                            <!-- Comment Meta -->
                                            <div class="comment-author">
                                                <img src="http://localhost/alazea/public/assets/img/bg-img/38.jpg" alt="">
                                            </div>
                                            <!-- Comment Content -->
                                            <div class="comment-content">
                                                <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li class="single_comment_area">
                                <div class="comment-wrapper d-flex">
                                    <!-- Comment Meta -->
                                    <div class="comment-author">
                                        <img src="http://localhost/alazea/public/assets/img/bg-img/39.jpg" alt="">
                                    </div>
                                    <!-- Comment Content -->
                                    <div class="comment-content">
                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="author-widget">
                            <div class="author-thumb-name d-flex align-items-center">
                                <div class="author-thumb">
                                    <img src="http://localhost/alazea/public/assets/img/bg-img/29.jpg" alt="">
                                </div>
                    ...
                    <div class="single-widget-area">
                        ...
                        <div class="single-latest-post d-flex align-items-center">
                            <div class="post-thumb">
                                <img src="http://localhost/alazea/public/assets/img/bg-img/30.jpg" alt="">
                            </div>
                            <div class="post-content">
                        ...
                        <div class="single-latest-post d-flex align-items-center">
                            <div class="post-thumb">
                                <img src="http://localhost/alazea/public/assets/img/bg-img/31.jpg" alt="">
                            </div>
                            <div class="post-content">
                                <a href="#" class="post-title">
                        ...
                        <div class="single-latest-post d-flex align-items-center">
                            <div class="post-thumb">
                                <img src="http://localhost/alazea/public/assets/img/bg-img/32.jpg" alt="">
                            </div>
                            <div class="post-content">
                                <a href="#" class="post-title">
                        ...
                        <div class="single-latest-post d-flex align-items-center">
                            <div class="post-thumb">
                                <img src="http://localhost/alazea/public/assets/img/bg-img/33.jpg" alt="">
                            </div>
                            <div class="post-content">
                                <a href="#" class="post-title">
                    ...
                    <div class="single-widget-area">
                        ...
                        <div class="single-best-seller-product d-flex align-items-center">
                            <div class="product-thumbnail">
                                <a href="shop-details.html"><img src="http://localhost/alazea/public/assets/img/bg-img/4.jpg" alt=""></a>
                            </div>
