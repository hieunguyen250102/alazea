...
<section class="portfolio-details-area section-padding-0-100">
    ...
    <div class="portfolio-slides owl-carousel mb-100">
        ...
        <div class="single-portfolio-slide">
            <img src="http://localhost/alazea/public/assets/img/bg-img/26.jpg" alt="">
        </div>
        <!-- Single Portfolio Slide -->
        <div class="single-portfolio-slide">
            <img src="http://localhost/alazea/public/assets/img/bg-img/27.jpg" alt="">
        </div>
        <!-- Single Portfolio Slide -->
        <div class="single-portfolio-slide">
            <img src="http://localhost/alazea/public/assets/img/bg-img/28.jpg" alt="">
        </div>
    </div>
