                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="product-img" href="http://localhost/alazea/public/assets/img/bg-img/49.jpg" title="Product Image">
                                        <img class="d-block w-100" src="http://localhost/alazea/public/assets/img/bg-img/49.jpg" alt="1">
                                    </a>
                                </div>
                            ...
                            <ol class="carousel-indicators">
                                <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(http://localhost/alazea/public/assets/img/bg-img/49.jpg);">
                                </li>
                                <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(http://localhost/alazea/public/assets/img/bg-img/49.jpg);">
                                </li>
                                <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(http://localhost/alazea/public/assets/img/bg-img/49.jpg);">
                                </li>
                            </ol>
                        </div>
                    </div>
